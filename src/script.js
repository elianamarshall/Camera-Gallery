...
loader.load(import.meta.env.BASE_URL + '/models/scene.glb', (gltfScene) => {
...
loadModel(import.meta.env.BASE_URL + '/models/brownieE.glb', 3, [6.1, 2.8, -1], Math.PI + 0.7, {
...
loadModel(import.meta.env.BASE_URL + '/models/agfaAnsco.glb', 3, [5.5, 2.8, -1], Math.PI + 0.8, {
...
loadModel(import.meta.env.BASE_URL + '/models/polaroidLand.glb', 3, [4.6, 2.8, -1.2], Math.PI + 0.7, {
...
loadModel(import.meta.env.BASE_URL + '/models/hawkeyeInstamatic.glb', 3, [3.6, 2.85, -1.2], Math.PI + 0.7, {
...
loadModel(import.meta.env.BASE_URL + '/models/fujifilmDL.glb', 3, [-3.6, 2.85, -1.2], Math.PI - 0.3, {
...
loadModel(import.meta.env.BASE_URL + '/models/automaticBrownie.glb', 3, [-4.7, 2.85, -1.2], Math.PI - 0.3, {
...
loadModel(import.meta.env.BASE_URL + '/models/brownieHawkeyeFlash.glb', 3, [-5.6, 2.8, -1], Math.PI - 0.3, {
...
loadModel(import.meta.env.BASE_URL + '/models/browniePremo.glb', 3, [-6.1, 2.8, -1], Math.PI - 0.4, {
...
loadModel(import.meta.env.BASE_URL + '/models/advantixT70.glb', 3, [6.1, 1.75, -1], -1.8, {
...
loadModel(import.meta.env.BASE_URL + '/models/starflash.glb', 3, [5.5, 1.75, -1], Math.PI + 0.7, {
...
loadModel(import.meta.env.BASE_URL + '/models/tele-instamatic.glb', 3, [4.6, 1.9, -1.35], Math.PI + 0.2, {
...
loadModel(import.meta.env.BASE_URL + '/models/canonEOS.glb', 3, [3.5, 1.8, -1.35], 0.5, {
...
loadModel(import.meta.env.BASE_URL + '/models/brownieFiesta.glb', 3, [-3.5, 1.8, -1.35], Math.PI - 0.5, {
...
loadModel(import.meta.env.BASE_URL + '/models/polaroidSun.glb', 3, [-4.8, 1.75, -1.2], Math.PI - 0.6, {
...
loadModel(import.meta.env.BASE_URL + '/models/brownie1A.glb', 3, [-5.4, 1.75, -1], Math.PI - 0.3, {
...
loadModel(import.meta.env.BASE_URL + '/models/instamaticM22.glb', 3, [-6, 1.7, -1.2], Math.PI - 0.7, {
...
loadModel(import.meta.env.BASE_URL + '/models/instamaticX-15.glb', 3, [6, 0.65, -1], Math.PI + 0.7, {
...
loadModel(import.meta.env.BASE_URL + '/models/advantixF600.glb', 3, [5.3, 0.75, -1.2], Math.PI + 0.5, {
...
loadModel(import.meta.env.BASE_URL + '/models/polaroidJoycam.glb', 3, [4.7, 0.7, -1.2], Math.PI + 0.7, {
...
loadModel(import.meta.env.BASE_URL + '/models/instaxMini.glb', 3, [3.5, 0.7, -1.35], Math.PI + 0.3, {
...
loadModel(import.meta.env.BASE_URL + '/models/brownieHawkeyeC.glb', 3.5, [-4.8, 0.7, -1.2], Math.PI - 0.6, {
...
loadModel(import.meta.env.BASE_URL + '/models/diana.glb', 3, [-5.4, 0.7, -1.2], Math.PI - 0.3, {
    name: 'Diana No. 151',
    year: '1960s',
...
loadModel(import.meta.env.BASE_URL + '/models/konica.glb', 3, [-5.8, 0.7, -1.4], Math.PI - 0.9, {
